...
- [Source and makefile "*tgz"](https://github.com/timkphd/examples/raw/code-examples/fort/90/source/archive.tgz)
...
- [https://github.com/llvm/llvm-project/blob/code-examples/flang/docs/FortranForCProgrammers.md](https://github.com/llvm/llvm-project/blob/code-examples/flang/docs/FortranForCProgrammers.md)
- [FFT stuff](../mkl/)
