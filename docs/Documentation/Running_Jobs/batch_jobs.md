...
To submit jobs on Kestrel, the Slurm sbatch command should be used:
...
| `$SLURM_CLUSTER_NAME` | The cluster name as per the master configuration in Slurm. Identical to `$NREL_CLUSTER`. | `kestrel`|
