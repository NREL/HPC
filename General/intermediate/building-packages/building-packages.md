...
1. [Acquire the package and set up for build]({% link General/intermediate/building-packages/acquire.md %})

2. [Configure, build, and install the package]({% link General/intermediate/building-packages/config_make_install.md %})

3. [Setting up your own environment module]({% link General/intermediate/building-packages/modules.md %})
